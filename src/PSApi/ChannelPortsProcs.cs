...
namespace PSFilterHostDll.PSApi
{
    ...
    internal unsafe delegate short ReadPixelsProc([In()] IntPtr port, [In()] PSScaling* scaling, [In()] VRect* writeRect, [In()] PixelMemoryDesc* destination, VRect* wroteRect);

    [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
    internal unsafe delegate short WriteBasePixelsProc([In()] IntPtr port, [In()] VRect* writeRect, [In()] PixelMemoryDesc source);
