...
{
    [Serializable]
    internal sealed class ActionDescriptorList
    {
        ...
        {
            this.items = new ReadOnlyCollection<ActionListSuite.ActionListItem>(collection);
        }
    }
    ...
    internal sealed class ActionListSuite : IActionListSuite
    {
        ...
        private sealed class ActionListItemCollection : Collection<ActionListItem>
        {
            ...
            public ActionListItemCollection Clone()
            {
                return new ActionListItemCollection(this);
            }

            public ActionDescriptorList ConvertToActionDescriptor()
            {
                List<ActionListItem> clone = new List<ActionListItem>(Items);
                return new ActionDescriptorList(clone);
            }
        }
        ...
        IntPtr IActionListSuite.CreateFromActionDescriptor(ActionDescriptorList descriptor)
        {
            ...
            this.actionLists.Add(list, new ActionListItemCollection(descriptor.Items));
        ...
        private int GetList(IntPtr list, uint index, ref IntPtr data)
        {
            ...
            if (index < items.Count)
            {
                ...
                try
                {
                    ...
                    this.actionLists.Add(list, value);
                }
                catch (OutOfMemoryException)
                {
                    return PSError.memFullErr;
