...
namespace PSFilterHostDll.PSApi.PICA
{
    ...
    [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
    internal delegate int ActionDescriptorHasKey(PIActionDescriptor descriptor, uint key, [MarshalAs(UnmanagedType.U1)] ref bool hasKey);

    [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
    internal delegate int ActionDescriptorGetCount(PIActionDescriptor descriptor, ref uint count);

    [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
    internal delegate int ActionDescriptorIsEqual(PIActionDescriptor descriptor, PIActionDescriptor other, [MarshalAs(UnmanagedType.U1)] ref bool isEqual);
    ...
    [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
    internal delegate int ActionDescriptorHasKeys(PIActionDescriptor descriptor, IntPtr requiredKeys, [MarshalAs(UnmanagedType.U1)] ref bool hasKeys);
