...
namespace PSFilterHostDll.PSApi
{
    ...
    [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
    internal delegate int ActionDescriptorHasKey(IntPtr descriptor, uint key, [MarshalAs(UnmanagedType.U1)] ref bool hasKey);

    [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
    internal delegate int ActionDescriptorGetCount(IntPtr descriptor, ref uint count);

    [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
    internal delegate int ActionDescriptorIsEqual(IntPtr descriptor, IntPtr other, [MarshalAs(UnmanagedType.U1)] ref bool isEqual);
    ...
    [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
    internal delegate int ActionDescriptorHasKeys(IntPtr descriptor, IntPtr requiredKeys, [MarshalAs(UnmanagedType.U1)] ref bool hasKeys);
